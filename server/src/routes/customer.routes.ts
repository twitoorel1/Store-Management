...
router.route('/id/:id').get(catchAsyncError(customerController.getOneById)).patch(catchAsyncError(customerController.updateOneById)).delete(catchAsyncError(customerController.deleteOneById));
